...
export const SAME_AS_PREVIOUS_PROOF_SLOT_ENCODING = "bytes-empty-same-as-previous-v1";
...
function proofSlotEncodingField(
  ...
  if (encoding !== SAME_AS_PREVIOUS_PROOF_SLOT_ENCODING && encoding !== FULL_PROOF_PLUS_PUBLIC_INPUT_DIGEST_V2) {
    errors.push({
      code: "unsupported_value",
      field,
      message:
